package ar.edu.itba.cep.evaluations_service.rest.config;
...
@ComponentScan(basePackages = {
        "ar.edu.itba.cep.evaluations_service.rest.controller"
})
@EnableJerseyApplication(basePackages = {
        "ar.edu.itba.cep.evaluations_service.rest.controller.endpoints",
